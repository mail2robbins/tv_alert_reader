          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto pr-2">
            ...
            <div>
              ...
              <input
                ...
                max="10"
                disabled={isSubmitting}
                value={formData.limitBufferPercentage || 0}
                onChange={(e) => handleInputChange('limitBufferPercentage', parseFloat(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white disabled:opacity-50 disabled:cursor-not-allowed"
              />
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Buffer added to LIMIT price. BUY: price + buffer%, SELL: price - buffer%. Default: 0%
              </p>
            </div>
